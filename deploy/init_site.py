...
bench('--site',site,'set-config','rpm_worklog_fresh_timezone','Asia/Taipei')
bench('--site',site,'install-app','rpm_worklog')
bench('--site',site,'migrate')
bench('--site',site,'execute','rpm_worklog.timezone.initialize')
bench('--site',site,'execute','rpm_worklog.timezone.verify')
